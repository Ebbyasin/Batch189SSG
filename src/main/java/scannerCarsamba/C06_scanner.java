...
public class C06_scanner {
    ...
    public static void main(String[] args) {
         ...
         */
        System.out.println("Isminiz : " +isim.toUpperCase().charAt(0) + isim.toLowerCase().substring(1));
        System.out.println("Soyisminiz : " +soyIsim.toUpperCase().charAt(0) + soyIsim.toLowerCase().substring(1));
    }
}
